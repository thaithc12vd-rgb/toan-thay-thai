...
# Hàm đọc file cập nhật dữ liệu mới nhất từ ổ đĩa (Sửa lỗi mất bài sau 1 ngày)
def doc_file(path):
...
# NẠP DỮ LIỆU CỨNG - Link luôn có nội dung vĩnh viễn
...
<style>
    ...
    /* --- PHỤC HỒI GIẤY KHEN CHUYÊN NGHIỆP --- */
    ...
    .cert-content {{ position: relative; z-index: 1; width: 100%; }}
...
if role == "teacher":
    ...
    # PHẦN HỌC SINH: library luôn được nạp từ file cứng ở đầu trang
